    ...
    <div class="relative">
        <div class="cursor-pointer outline-none">
            ...
            >
                ...
                <span class="text-xl" v-if="selected">
                    {{ selected }}
                </span>
            </button>
        </div>
        ...
        <scale-transition>
            ...
            >
                <div class="flex flex-wrap justify-start space-x-2">
                    <button
                        class="p-1 cursor-pointer rounded hover:bg-gray-300 focus:outline-none focus:shadow-outline text-2xl flex items-center justify-center h-6 w-6"
